...
exports.detectMultiFrame = exports.detectLandmarks = void 0;
const express_1 = require("express");
const HandDetectionService_1 = require("../../services/HandDetectionService");
const NoteMappingService_1 = require("../../services/NoteMappingService");
const detectLandmarks = (req, res) => {
    ...
    const detectionResult = HandDetectionService_1.handDetectionService.processLandmarks(landmarks, startTime);
    ...
    const currentNote = NoteMappingService_1.noteMappingService.determineNote(holeState);
    const frequency = NoteMappingService_1.noteMappingService.getFrequency(currentNote);
    res.json({
        fingerState: {
...
const detectMultiFrame = (req, res) => {
    ...
    try {
        const results = frames.map((frame) => {
            ...
            const detectionResult = HandDetectionService_1.handDetectionService.processLandmarks(frame.landmarks, startTime);
            const holeState = {
                H1: !detectionResult.fingers.thumb.lifted,
                H2: !detectionResult.fingers.indexFinger.lifted,
                H3: !detectionResult.fingers.middleFinger.lifted,
...
exports.detectMultiFrame = detectMultiFrame;
