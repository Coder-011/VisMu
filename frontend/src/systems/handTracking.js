...
export function detectNoteFromLandmarks(landmarks) {
...
export class HandTracking {
    ...
    async initAsync() {
        try {
            ...
            const filesetResolver = await FilesetResolver.forVisionTasks('https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.16/wasm');
...
//# sourceMappingURL=handTracking.js.map