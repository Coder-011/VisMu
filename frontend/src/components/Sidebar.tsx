  ...
  return (
    <div className="w-64 h-full bg-[#0a0a0a] border-r border-[#1a1a1a] flex flex-col p-6">
      ...
      <div className="mt-auto space-y-6">
        <button className="w-full py-3 bg-[#00f2ff] text-black rounded font-bold text-[11px] tracking-widest flex items-center justify-center space-x-2 hover:bg-[#00d8e4] transition-colors">
          <Settings2 size={16} />
